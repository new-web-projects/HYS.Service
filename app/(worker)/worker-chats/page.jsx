...
const STATUS_LABELS = {
  ...
  price_proposed:  { label: 'Awaiting Accept', cls: 'bg-amber-100  text-amber-700'  },
...
export default function WorkerChatsPage() {
  ...
  useEffect(() => {
    if (user?.uid) subscribeChats(user.uid, 'worker');
      ...
      {!chatsLoading && chats.length === 0 && (
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm
            ...
            >
              <path
                ...
                d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847
                   ...
                   1.614-2.76 3.235v6.226c0 1.621 1.152 3.026 2.76 3.235.577.075
          ...
          <p className="text-gray-400 text-sm leading-relaxed max-w-xs mx-auto">
            When customers view your profile and start a conversation,
            their messages will appear here.
          </p>
          <div className="pt-2 space-y-2">
            <p className="text-gray-400 text-xs">
              Make sure your profile is complete and availability is turned on.
            </p>
            <Link
              href="/worker-profile"
      ...
      {!chatsLoading && chats.length > 0 && (
        <div className="space-y-3">
          {chats.map((chat) => {
            ...
            // Build peer (customer) object for ChatModal
            const peerForModal = {
              uid:             chat.customerId,
              id:              chat.customerId,
            ...
            return (
              ...
              >
                ...
                <div
                  className="w-12 h-12 rounded-xl overflow-hidden bg-blue-50
